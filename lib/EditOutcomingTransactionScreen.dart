...
class EditOutcomingTransactionScreen extends StatefulWidget {
  final DocumentSnapshot transaction;

  EditOutcomingTransactionScreen(this.transaction);

  @override
  _EditTransactionScreenState createState() => _EditTransactionScreenState();
}

class _EditTransactionScreenState extends State<EditOutcomingTransactionScreen> {
